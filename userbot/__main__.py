...
sed = logging.getLogger("Genius Savage")
...
print("𝐒𝐀𝐕𝐀𝐆𝐄 𝐒𝐀𝐕𝐀𝐆𝐄 has been deployed! ")

print("Setting up 𝐒𝐀𝐕𝐀𝐆𝐄 𝐒𝐀𝐕𝐀𝐆𝐄")
...
if Config.ENABLE_ASSISTANTBOT == "ENABLE":
    ...
    sed.info("𝐒𝐀𝐕𝐀𝐆𝐄 𝐒𝐀𝐕𝐀𝐆𝐄 Bot Have Been Installed Successfully !")
else:
    sed.info("𝐒𝐀𝐕𝐀𝐆𝐄 𝐒𝐀𝐕𝐀𝐆𝐄 Has Been Installed Sucessfully !")
    sed.info("You Can Visit @SAVAGE_TEAM_CLUB For Any Support Or Doubts")
