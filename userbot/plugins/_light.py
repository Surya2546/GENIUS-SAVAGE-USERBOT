...
async def cmd_list(event):
    if not event.text[0].isalpha() and event.text[0] not in ("/", "#", "@", "!"):
        geniussavage = Var.TG_BOT_USER_NAME_BF_HER
        ...
        if lightningusername is None or input_str == "text":
            ...
            light_help_strin = """**GENIUS SAVAGE Heres With The Detailed Help For CMDs** 😉😉 !\n If Faced Any Bug Please Give The Feed Back at @SAVAGE_TEAM_CLUB:"""
