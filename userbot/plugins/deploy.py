...
async def _(event):
    ...
    animation_chars = [
        "**Heroku Connecting To Latest Github Build (SAMMER2021/GENIUS-SAVAGE-USERBOT-)**",
        ...
        "__INFO:Genius savage:Logged in as 557667062__",
        "__INFO:Genius savage:Successfully loaded all plugins__",
        "**Build Succeeded**",
    ]
