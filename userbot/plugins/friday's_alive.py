...
if FRI_IMAGE is None:
    FRI_IMG = "https://telegra.ph/file/51fa431e68e392d0afcd6.mp4"
else:
    FRI_IMG = FRI_IMAGE
...
pm_caption = "➥ **GENIUS SAVAGE IS:** `ONLINE`\n\n"
...
pm_caption += "➥ **Copyright** : By [SAMMER2021@Github](https://github.com/SAMMER2021)\n"
pm_caption += "➥ **Check Stats By Doing** `.stat`. \n\n"
pm_caption += (
    "[🇮🇳 Deploy GENIUS SAVAGE 🇮🇳](https://telegra.ph/file/cc09334b76112d75dbf8f.jpg)"
)
